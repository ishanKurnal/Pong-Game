...
3. A launch page will appear after running PongGame.java.
4. The launch page includes three buttons i-e., a button to launch the main game, a button to open the game’s instruction manual, and an exit button.